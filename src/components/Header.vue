  ...
  <div class="header" :style="positions">
      ...
      <div id="nav" class="clearfloat">
        <ul class="clearfloat ul">
            ...
            <div class="gzh_div">
              <div class="gzh_img">
                <img
                  ...
                  src="../assets/images/header/gzh.jpg"
                  alt=""
                />
              </div>
          ...
          <li>
            ...
            >
              <span class="shu"></span>
              <img class="person-img" src="../assets/images/person.png" alt />
              登陆/注册
            </router-link>
            ...
            >
              ...
              <!-- 个人中心 -->
              <span
                style="color: #0a0a0a;width: 60%;height: 100%;display: block;"
                @mouseover="getqian()"
              >
                ...
                <div class="site-nav-menu-bd-panel">
                  <div class="site-nav-user-wrapper ">
                    ...
                    <div>
                      ...
                      <a
                        href="#/person"
                        style="line-height: 58px; font-size: 16px;"
                        >{{ $store.getters.getMobile }}</a
                      >
                    </div>
                  </div>
                  ...
                  <div class="site-nav-user-info">
                    <div style="display: flex;    height: 20px;">
                      <img
                        class="site-nav-user-info-img"
                        src="../assets/images/header/icon_coinpurse_line.png"
                        alt=""
                      />
                      <span class="level-info tao-score">余 </span
                    ...
                    <div style="display: flex;    height: 20px;">
                      <img
                        class="site-nav-user-info-img"
                        src="../assets/images/header/icon-test.png"
                        alt=""
                      />
                      <span class="level-info tao-score"
                        >保证金：{{ user.bond }}</span
                      >
                    </div>
                    <div style="display: flex;    height: 20px;">
                      <img
                        ...
                        alt=""
                      />
                      <span v-if="user.level > 1" class="level-info">{{
                        user.level_text
                      }}</span>
                      <span
                        v-if="user.level > 1"
                        ...
                        class="level-info"
                        >{{ getVipTime(user.end_time) }}</span
                      >

                      <span v-if="user.level < 2" class="level-info"
                        >普通会员</span
                      >
                    </div>
                  </div>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="(centerDialogVisible = false), outLog()"
          >不看了</el-button
        >
        <el-button type="primary" @click="(centerDialogVisible = false), qu()"
          >去看看</el-button
        >
      </span>
    </el-dialog>
