<template>
	<div>
		 ...
		 :visible.sync="zfqrk" :modal="false" width="500px">
			...
			<el-form label-width="200px">
				...
				<el-form-item v-if="chaxuntype==0" label="订单金额: ">
					...
					<span v-else>{{dingdan.pay_num}}元</span>
				</el-form-item>
		...
		<el-dialog :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false" :title="this.title"
		 :modal="false" :visible.sync="dialogVisibleWZ" :before-close="handleClose" width="30%" style="margin-top: 300px;">
			<span>
		...
		<div class="card">
			...
			<!-- <div class="card-item3 card-item"> -->
