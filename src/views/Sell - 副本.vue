	...
	<div class="sell" style="height: 1380px;">
		<div class="sell-inner">
            ...
            <input class="fc-input" v-model="form.car_category" placeholder="请输入主营品类" type="text" />clearable :props="areaProp" 
				...
				<!-- 身份证上传 -->
				<div class="idcard">
					<el-upload name="file" class="img-item" :action="baseURL+'api/common/upload'" :show-file-list="false"
				...
				<div class="option">
					...
					<div style="margin: 76px auto 0 auto;;width: 819px;"><button @click="shopSettled" class="ok">{{anniutext}}</button></div>
	...
	export default {
		...
		methods: {
			...
			handleAvatarSuccessA(res, file) {
				...
				this.form.id_photo_0 = res.data.url
			},
			handleAvatarSuccessB(res, file) {
				
				this.$set(this.imageUrl, 1, res.data.url)
				this.form.id_photo_1 = res.data.url
			},
