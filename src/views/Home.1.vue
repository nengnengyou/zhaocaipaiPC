  ...
  <div>
          ...
          <div class="home_top">
            ...
            <div style="margin: 0 auto;width: 1170px;;">
              <ul style="list-style: none;">
                <li
                  @mouseover="hover('86px')"
                  style="float: left;"
                  class="cangciitem item1"
                >
                  <a href="index.html#/auctionhome" target="_blank"
                    ><img
                      class="navimage"
                      id="li1"
                      ref="li1"
                      src="../assets/images/home/home_pczc1.jpg"
                      alt=""
                  /></a>
                </li>
                <li
                  @mouseover="hover('285px')"
                  style="float: left;"
                  class="cangciitem item2"
                >
                  <a href="index.html#/conveniently" target="_blank"
                    ><img
                      class="navimage"
                      ref="li2"
                      id="li2"
                      src="../assets/images/home/home_sspw2.jpg"
                      alt=""
                  /></a>
                </li>
                <li
                  @mouseover="hover('477px')"
                  style="float: left;"
                  class="cangciitem item3"
                >
                  <a href="index.html#/buycomm" target="_blank"
                    ><img
                      class="navimage"
                      ref="li3"
                      id="li3"
                      src="../assets/images/home/home_sjcy2.jpg"
                      alt=""
                  /></a>
                </li>
                <!-- <li @mouseover="hover('581px')" style="float: left;" class="cangciitem item4"><img class="navimage" id="li4" src="../assets/images/home/home_pjsc1.jpg"
									 alt=""></li> -->
                <li
                  @mouseover="hover('670px')"
                  style="float: left;"
                  class="cangciitem item5"
                >
                  <a href="index.html#/service" target="_blank"
                    ><img
                      class="navimage"
                      ref="li5"
                      id="li5"
                      src="../assets/images/home/home_cyfw2.jpg"
                      alt=""
                  /></a>
                </li>
                <li
                  @mouseover="hover('870px')"
                  style="float: left;"
                  class="cangciitem item6"
                >
                  <a href="index.html#/quan" target="_blank"
                    ><img
                      class="navimage"
                      ref="li6"
                      id="li6"
                      src="../assets/images/home/home_cyq2.jpg"
                      alt=""
                  /></a>
                </li>
                <li
                  @mouseover="hover('1060px')"
                  style="float: left;"
                  class="cangciitem item7"
                >
                  <a href="index.html#/live" target="_blank"
                    ><img
                      class="navimage"
                      ref="li7"
                      id="li7"
                      src="../assets/images/home/home_jczb2.jpg"
                      alt=""
                  /></a>
                </li>
              </ul>
            ...
            <div class="Venue_content">
              ...
              >
                ...
                <div
                  style="width: 95%;height: 80%;text-align: center;background-color: #eeeeee;margin: 10px auto 0 auto; "
                >
    ...
    color: rgb(123, 121, 121);">更多>></a>
          ...
          <div class="Auction" ref="Auction">
            ...
            <div style="padding-top: 30px;">
              <div class="Auction_content">
                <span
                  style="display: block;width: 97px;margin: 0 auto;"
                  v-if="zhanwu"
                  >暂无竞拍车辆</span
                >
                ...
                >
                  ...
                  <div class="Auction_content_item_right">
                    ...
                    <div
                      style="background-color:#0f94fa; height: 75px; line-height: 75px; float: right; text-align: center; padding: 0px 10px;"
                    >
                      <p>
    ...
    float: left;"
                    ...
                    <div style=" padding-left: 8px; float: left;display: flex;">
                      ...
                      <div
                        class="item-text"
                        style="position: absolute;right: 148px;"
                      >
                        结束时间:
                    ...
                    <div style="padding: 11px;">
                      <span
                        style="
												...
												height: 18px;
												overflow: hidden;"
                        >商品名称:{{ Conveniently[index].Name }}</span
                      >
                      <div class="bottom clearfix">
                        <div class="time">
                          当前价格:{{ Conveniently[index].Price }}
                        </div>

                        <div class="time">
                          出价次数:{{ Conveniently[index].Frequency }}
                        </div>
                      </div>
                      <div class="time" style="float: right;">
                        {{ Conveniently[index].Time }}
                      </div>
                    </div>
                  </el-card>
                </el-col>
                  ...
                  >
                    ...
                    >
                      <img
                        :src="item3.image[0]"
                        class="image"
                        @click="Auction3_item(item3.id, item3.shop_id)"
                      />
                      <div style="padding: 14px;">
                        <span
                          class="card-title"
                          @click="Auction3_item(item3.id)"
                          >商品名称:{{ item3.title }}</span
                        >
                        <div class="bottom clearfix">
                          <div class="time">
                            地址:{{ item3.province }}-{{ item3.area }}
                          </div>
        ...
        .then((response) => {
          ...
          if (this.package.length > 0) {
            this.$refs.box.style.height =
              this.boxh + 246 * this.package.length + "px";

            //修改父div高度  // - 60 * this.package.length
            this.$refs.Auction.style.height =
              246 * this.package.length + 58 + "px";
          }
  ...
  data() {
    return {
      ...
      text: [
        {
          html:
            '<div style="width: 95%;height: 80%;text-align: center;background-color: #eeeeee;margin: 10px auto 0 auto; ">1+',
        },
        {
          html:
            '<div style="width: 95%;height: 80%;text-align: center;background-color: #eeeeee;margin: 10px auto 0 auto; ">1+',
