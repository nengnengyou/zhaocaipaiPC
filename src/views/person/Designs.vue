	...
	<div id="person-design">
		...
		<el-form :inline="true" label-width="150px" ref="form" :model="form">
			...
			<el-form-item label="上牌时间：">
				<!--        <el-input style="width:265px" v-model="form.card_time"></el-input>-->
			...
			<el-form-item label="竞拍天数：">
				<el-input style="width:265px" v-model="form.days"></el-input>
			</el-form-item>
	...
	export default {
		...
		methods: {
			...
			getCarinfo() {
				...
				//console.log(a)
				this.$api.shangjiache2({id:i}).then(res=>{
					let a=res.data
					// this.form=res.data
